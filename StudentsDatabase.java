...
public class StudentsDatabase implements StudentsDatabaseInterface, TableInterface
{
    ...
    class Students
    {
        ...
        public void updateStudents(String column, String input, String courseID)
        {
            String sqlInsert = StudentsDatabaseInterface.updateTableStudents(column, input, courseID);
            try
            {
                connection.prepareStatement(sqlInsert).executeUpdate();
            }
    ...
    class Classes
    {
        ...
        public void updateClasses(String column, String input, String courseID)
        {
            String sqlInsert = StudentsDatabaseInterface.updateTableClasses(column, input, courseID);
            try
            {
                connection.prepareStatement(sqlInsert).executeUpdate();
            }
